	...
	: Super(ObjectInitializer)
{
	...
	CameraComp = ObjectInitializer.CreateDefaultSubobject<UCameraComponent>(this, TEXT("FPSCamera"));
	CameraComp->bUsePawnControlRotation = true;
	CameraComp->SetupAttachment(RootComponent);

	WeaponSprite = ObjectInitializer.CreateDefaultSubobject<UPaperFlipbookComponent>(this, TEXT("WeaponSprite"));
	WeaponSprite->bOnlyOwnerSee = true;
	WeaponSprite->bOwnerNoSee = false;
	WeaponSprite->AttachToComponent(CameraComp, FAttachmentTransformRules::SnapToTargetIncludingScale);
...
void AVNPlayerPaperCharacter::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	Super::EndPlay(EndPlayReason);
}

void AVNPlayerPaperCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	check(PlayerInputComponent);
	PlayerInputComponent->BindAxis("MoveForward", this, &AVNPlayerPaperCharacter::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AVNPlayerPaperCharacter::MoveRight);

	PlayerInputComponent->BindAction("Jump", IE_Pressed, this, &AVNPlayerPaperCharacter::OnJump);
	PlayerInputComponent->BindAction("Sprint", IE_Pressed, this, &AVNPlayerPaperCharacter::OnStartSprinting);
	PlayerInputComponent->BindAction("Sprint", IE_Released, this, &AVNPlayerPaperCharacter::OnStopSprinting);
	PlayerInputComponent->BindAction("SprintToggle", IE_Pressed, this, &AVNPlayerPaperCharacter::OnStartSprintingToggle);
	PlayerInputComponent->BindAction("CrouchToggle", IE_Pressed, this, &AVNPlayerPaperCharacter::OnCrouchToggle);

	PlayerInputComponent->BindAction("Targeting", IE_Pressed, this, &AVNPlayerPaperCharacter::OnStartTargeting);
	PlayerInputComponent->BindAction("Targeting", IE_Released, this, &AVNPlayerPaperCharacter::OnStopTargeting);
	PlayerInputComponent->BindAction("Fire", IE_Pressed, this, &AVNPlayerPaperCharacter::OnStartFire);
	PlayerInputComponent->BindAction("Fire", IE_Released, this, &AVNPlayerPaperCharacter::OnStopFire);
	PlayerInputComponent->BindAction("Reload", IE_Pressed, this, &AVNPlayerPaperCharacter::OnReload);

	PlayerInputComponent->BindAction("InventoryPistol", IE_Pressed, this, &AVNPlayerPaperCharacter::OnEquipPistol);
	PlayerInputComponent->BindAction("InventoryShotgun", IE_Pressed, this, &AVNPlayerPaperCharacter::OnEquipShotgun);
	PlayerInputComponent->BindAction("InventoryRifle", IE_Pressed, this, &AVNPlayerPaperCharacter::OnEquipRifle);
	PlayerInputComponent->BindAction("InventoryDoubleBarrel", IE_Pressed, this, &AVNPlayerPaperCharacter::OnEquipDoubleBarrel);
	PlayerInputComponent->BindAction("InventoryGrenadeLauncher", IE_Pressed, this, &AVNPlayerPaperCharacter::OnEquipGrenadeLauncher);
	PlayerInputComponent->BindAction("InventoryPlasmaRifle", IE_Pressed, this, &AVNPlayerPaperCharacter::OnEquipPlasmaRifle);

	PlayerInputComponent->BindAction("InventoryFirst", IE_Pressed, this, &AVNPlayerPaperCharacter::OnEquipFirst);
	PlayerInputComponent->BindAction("InventorySecond", IE_Pressed, this, &AVNPlayerPaperCharacter::OnEquipSecond);
	PlayerInputComponent->BindAction("InventoryThird", IE_Pressed, this, &AVNPlayerPaperCharacter::OnEquipThird);
	PlayerInputComponent->BindAction("InventoryFourth", IE_Pressed, this, &AVNPlayerPaperCharacter::OnEquipFourth);
...
void AVNPlayerPaperCharacter::OnJump()
{
	SetIsJumping(true);
}

bool AVNPlayerPaperCharacter::IsInitiatedJump() const
{
	return bIsJumping;
}
...
void AVNPlayerPaperCharacter::DoubleJump()
{
	...
	const bool bXYOverride = FVector::DotProduct(GetLastMovementInputVector(), GetVelocity()) < 0;
	LaunchCharacter(Velocity, bXYOverride, true);
	bCanDoubleJump = false;
}

void AVNPlayerPaperCharacter::OnMovementModeChanged(EMovementMode PrevMovementMode, uint8 PreviousCustomMode)
{
...
void AVNPlayerPaperCharacter::OnStartSprinting()
{
	SetSprinting(true, false);
}

void AVNPlayerPaperCharacter::OnStopSprinting()
{
	SetSprinting(false, false);
}
...
void AVNPlayerPaperCharacter::OnStartTargeting()
{
	SetTargeting(true);
}

void AVNPlayerPaperCharacter::OnStopTargeting()
{
	SetTargeting(false);
}
...
{
	return bIsSliding && GetVelocity().Size() > GetCharacterMovement()->GetMaxSpeed();
}

bool AVNPlayerPaperCharacter::CanFire() const
{
	return IsAlive();
}
...
void AVNPlayerPaperCharacter::SetCurrentWeapon(class AVNWeapon* NewWeapon, class AVNWeapon* LastWeapon)
{
...
void AVNPlayerPaperCharacter::OnStopFire()
{
	StopWeaponFire();
}
...
void AVNPlayerPaperCharacter::SpawnDefaultInventory()
{
	for (int32 i = 0; i < DefaultInventory.Num(); i++)
	{
		...
		AVNWeapon* Weapon = GetWorld()->SpawnActor<AVNWeapon>(DefaultInventory[i], SpawnInfo);
		AddWeapon(Weapon);
	}
...
int32 AVNPlayerPaperCharacter::GetMaxAmmoByType(EWeaponAmmoType AmmoType) const
{
	if (InventoryAmmo.Num() <= 0 || !InventoryAmmo.Contains(AmmoType))
		return 0;
	return GetClass()->GetDefaultObject<AVNPlayerPaperCharacter>()->InventoryAmmo[AmmoType];
}
