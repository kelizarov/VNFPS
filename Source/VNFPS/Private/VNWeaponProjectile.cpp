...
void AVNWeaponProjectile::SpawnProjectile(const FVector& Origin, const FVector& ShootDir)
{
	FTransform SpawnTM(ShootDir.Rotation(), Origin);
	DrawDebugLine(GetWorld(), Origin, Origin + (ShootDir * 100.f), FColor::Red, false, 2.f);
